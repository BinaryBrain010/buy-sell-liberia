...
const initialCategories: CategoryType[] = [
  {
    ...
    subcategories: [
      ...
      },
      {
        name: "Accessories",
        slug: "accessories",
        description: "Chargers, Headphones, etc.",
        isActive: true,
        sortOrder: 4,
        customFields: [],
      },
      ...
      },
      {
        name: "Cameras & Drones",
        slug: "cameras-drones",
        description: "Photography and drone equipment",
        isActive: true,
        sortOrder: 6,
        customFields: [],
      },
    ...
    subcategories: [
      {
        ...
        description: "Sofas, tables, and living room items",
        isActive: true,
        sortOrder: 1,
        customFields: [],
      },
      {
        ...
        description: "Beds, wardrobes, and bedroom items",
        isActive: true,
        sortOrder: 2,
        customFields: [],
      },
      {
        name: "Kitchen & Dining",
        slug: "kitchen-dining",
        description: "Kitchen appliances and dining furniture",
        isActive: true,
        sortOrder: 3,
        customFields: [],
      },
      {
        name: "Home Decor",
        slug: "home-decor",
        description: "Decoration and home accessories",
        isActive: true,
        sortOrder: 4,
        customFields: [],
      },
  ...
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        name: "Power Tools",
        slug: "power-tools",
        description: "Electric and power tools",
        isActive: true,
        sortOrder: 2,
        customFields: [],
      },
    ...
    subcategories: [
      {
        name: "IT & Technology",
        slug: "it-technology",
        description: "Software, web development, and IT services",
        isActive: true,
        sortOrder: 1,
        customFields: [],
      },
      {
        ...
        description: "Graphic design, photography, and creative services",
        isActive: true,
        sortOrder: 2,
        customFields: [],
      },
  ...
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        name: "Part-time Jobs",
        slug: "part-time-jobs",
        description: "Part-time and temporary jobs",
        isActive: true,
        sortOrder: 2,
        customFields: [],
      },
      ...
      },
      {
        name: "Internships",
        slug: "internships",
        description: "Internship and training opportunities",
        isActive: true,
        sortOrder: 4,
        customFields: [],
      },
    ...
    subcategories: [
      {
        name: "Team Sports",
        slug: "team-sports",
        description: "Football, basketball, and team sports equipment",
        isActive: true,
        sortOrder: 1,
        customFields: [],
      },
  ...
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        name: "Computer Parts",
        slug: "computer-parts",
        description: "Processors, RAM, and computer components",
        isActive: true,
        sortOrder: 3,
        customFields: [],
      },
    ...
    subcategories: [
      {
        ...
        description: "Stoves, ovens, and cooking equipment",
        isActive: true,
        sortOrder: 1,
        customFields: [],
      },
      ...
      },
      {
        ...
        description: "Blenders, toasters, and small kitchen tools",
        isActive: true,
        sortOrder: 3,
        customFields: [],
      },
    ...
    subcategories: [
      {
        ...
        description: "Tractors and farming machinery",
        isActive: true,
        sortOrder: 1,
        customFields: [],
      },
  ...
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        description: "Novels, poetry, and literature",
        isActive: true,
        sortOrder: 2,
        customFields: [],
      },
  ...
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        name: "Other Pets",
        slug: "other-pets",
        description: "Other animals and pets",
        isActive: true,
        sortOrder: 3,
        customFields: [],
      },
      {
        name: "Pet Supplies",
        slug: "pet-supplies",
        description: "Food, toys, and pet accessories",
        isActive: true,
        sortOrder: 4,
        customFields: [],
      },
