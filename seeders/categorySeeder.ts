...
// Define a plain interface for seeding data, excluding Mongoose document properties
interface ICategorySeed {
  ...
  isActive?: boolean;
  sortOrder?: number;
  subcategories: ISubcategorySeed[];
}

interface ISubcategorySeed {
  name: string;
  slug: string;
  description?: string;
  isActive?: boolean;
...
async function seedCategories() {
  try {
    ...
    // Define categories based on provided mock data
