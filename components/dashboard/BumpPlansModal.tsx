...
export default function BumpPlansModal({ open, onOpenChange }: Props) {
  ...
  function handleBuy() {
    ...
    if (!plan) return;
    // TODO: integrate payment flow. This is a placeholder.
    alert(
      `Buy placeholder: ${plan.title ?? plan.bumps + " bumps"} - ${
        plan.price
      } ${plan.currency}`
    );
    onOpenChange(false);
