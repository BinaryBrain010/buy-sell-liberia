  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-xl font-bold">Your Favourites</h2>
          <p className="text-sm text-muted-foreground">
            {favourites.length} saved listing{favourites.length !== 1 ? "s" : ""}
          </p>
        </div>
        ...
        <Card className="text-center py-12">
          <CardContent>
            ...
            <p className="text-muted-foreground mb-4">
              {searchTerm ? "Try adjusting your search terms" : "Start browsing listings and save your favourites here"}
            </p>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between pt-2">
                    <div className="text-sm">
                      ...
                      <span className="text-yellow-500 ml-1">★ {listing.seller.rating}</span>
                    </div>
                  </div>
                </div>

                <div className="flex gap-2 mt-4">
                  <Button className="flex-1" disabled={listing.status === "sold"}>
