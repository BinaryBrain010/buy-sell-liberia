...
const securityFeatures = [
  ...
  },
  {
    ...
    description:
      "All sellers go through our verification process to ensure authenticity and trust.",
  ...
  },
  {
    ...
    description:
      "Built by Liberians, for Liberians. We understand local needs and preferences.",
  ...
  },
  {
    ...
    description:
      "Our team reviews listings to maintain high standards and prevent fraud.",
...
const platformFeatures = [
  {
    ...
    description:
      "Read authentic reviews from real buyers and sellers before making decisions.",
  ...
  },
  {
    ...
    description:
      "Access our platform seamlessly on any device, anywhere in Liberia.",
  ...
  },
  {
    ...
    title: "Local Focus",
    description:
      "Connect with people in your area for easier meetups and faster transactions.",
  ...
  },
  {
    ...
    title: "Fast & Reliable",
    description:
      "Quick loading times and 99.9% uptime, even with limited internet connectivity.",
      ...
      <div className="container mx-auto px-4 relative z-20">
                    ...
                    <Card className="relative bg-gradient-to-br from-background/90 to-muted/30 backdrop-blur-sm border-2 border-border/50 hover:border-primary/50 hover:shadow-2xl hover:shadow-primary/20 transition-all duration-300 overflow-hidden">
                      <CardContent className="p-8">
                        <div className="flex items-start gap-6">
                          <div
                            className={`w-20 h-20 rounded-3xl bg-gradient-to-br ${feature.color} flex items-center justify-center shadow-xl ring-4 ring-white/30 relative overflow-hidden group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 flex-shrink-0`}
                          >
                  ...
                  <Card className="relative bg-gradient-to-br from-background/80 via-muted/10 to-background/80 backdrop-blur-sm border-2 border-border/30 hover:border-primary/60 hover:shadow-2xl hover:shadow-primary/25 transition-all duration-500 h-full overflow-hidden">
                    ...
                    <CardContent className="p-8 relative z-10">
                      <div className="flex flex-col items-center text-center">
                        <div
                          className={`w-24 h-24 mb-6 rounded-full bg-gradient-to-br ${feature.color} flex items-center justify-center shadow-2xl ring-8 ring-white/20 relative overflow-hidden group-hover:scale-125 group-hover:rotate-12 transition-all duration-500`}
                        >
                          <div className="absolute inset-0 bg-gradient-to-br from-white/30 to-transparent" />
        ...
        <div>
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Our commitment to excellence is reflected in our growing community
              and success metrics
            </p>
          </div>
