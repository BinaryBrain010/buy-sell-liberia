...
import { Heart, MapPin, Eye, Clock, Star, User } from "lucide-react";
...
type PriceType =
  | number
  | { amount: number; currency?: string; negotiable?: boolean };
...
export function ProductCard({
  ...
  if (Array.isArray(product.images)) {
    primaryImage =
      product.images.find(
        (img: any) => typeof img === "object" && img.isPrimary
      ) || product.images[0];
  }
                  ...
                  <Image
                    ...
                    alt={
                      typeof primaryImage === "object"
                        ? primaryImage.alt || product.title || "Product image"
              ...
              <CardContent className="flex-1 p-3 flex flex-col justify-between min-h-[128px]">
                <div className="flex flex-col gap-1 flex-1">
                  ...
                  <div className="flex flex-wrap gap-1 mt-1 min-h-[22px]">
                    {Array.isArray(product.tags) && product.tags.length > 0 ? (
                      ...
                      <span className="text-[10px] text-muted-foreground opacity-0 select-none">
                        No tags
                      </span>
                    )}
                  </div>
                ...
                <div className="flex items-center justify-between mt-2 pt-2 border-t border-gray-100">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-xs font-medium line-clamp-1 max-w-[80px]">
                      {displayName}
                    </span>
                  </div>
                  <div
                  ...
                  >
                    <ContactSellerButton
                      sellerId={
                        product.seller?._id || product.user_id?._id || ""
                      }
