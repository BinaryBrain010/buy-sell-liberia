...
export default function CategoriesPage() {
  const { categories, loading: categoriesLoading } = useCategories(true, 5) // Get categories with 5 products each
    ...
    <div className="min-h-screen">
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground">Browse products by category</p>
        </div>

        {/* Quick Links */}
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          <Link href="/products">
            <Button variant="outline" size="lg" className="glass border-0 btn-shadow">
              All Products
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      {category.totalCount?.toLocaleString() || 0} products available
                    </p>
                  </div>
                </div>
                ...
                <div className="mb-6">
                  <div className="flex flex-wrap gap-2">
                    {category.subcategories.slice(0, 6).map((subcategory) => (
                      <Link key={subcategory._id} href={`/categories/${category.slug}/${subcategory.slug}`}>
                        <Badge 
                          variant="secondary" 
